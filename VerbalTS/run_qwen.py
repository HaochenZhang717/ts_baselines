...
def train(training_stage, train_configs, model_diff_configs, model_cond_configs, eval_configs,  output_folder):
    ...
    if training_stage == "finetune":
        ...
        model = ConditionalGeneratorQwen(model_diff_configs, model_cond_configs)
    else:
...
def run(training_stage, train_configs, eval_configs, model_diff_configs, model_cond_configs, output_folder, only_evaluate=False):
...
for n in range(args.start_runid, args.n_runs):
    ...
    run(
        args.training_stage, train_configs, eval_configs,
        model_diff_configs, model_cond_configs, output_folder,
