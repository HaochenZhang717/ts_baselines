...
from models.diffusion.verbalts_debug import VerbalTSDebug
...
class UnConditionalGeneratorDebug(nn.Module):
    ...
    def _init_diff(self, configs):
        ...
        if configs["type"] == "Text2Ts":
            self.diff_model = VerbalTSDebug(configs, input_dim).to(self.device)
