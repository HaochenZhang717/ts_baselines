...
from models.diffusion.verbalts_qwen_v4 import VerbalTSQwenV4
...
class UnConditionalGeneratorQwenV4(nn.Module):
    ...
    def _init_diff(self, configs):
        ...
        self.diff_model = VerbalTSQwenV4(configs, inputdim=1).to(self.device)
