...
from models.unconditional_generator_qwen_v3 import UnConditionalGeneratorQwenV3
...
class ConditionalGeneratorQwenV3(nn.Module):
    ...
    def _init_diff(self, configs):
        ...
        self.generator = UnConditionalGeneratorQwenV3(configs=configs)
