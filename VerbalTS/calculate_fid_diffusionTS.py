...
def get_args():
    ...
    parser.add_argument("--real_path", type=str, default="baseline_results/diffusionts_results/synth_u/ddpm_fake_synth_u.npy")
    parser.add_argument("--fake_path", type=str, default="baseline_results/diffusionts_results/synth_u/ddpm_fake_synth_u.npy")
